#__________________________HEADER_________________
...
#_________________DISPLAYS THE DATA_______________
    def display(self):
        f=0
        fin1=open(r"E:\Python Files\tickets.dat","rb")
        if not fin1:
            print ("ERROR")
        else:
            print
    ...
    def cancellation(self):
        z=0
        f=0
        fin=open(r"E:\Python Files\tickets.dat","rb","rb")
        fout=open(r"E:\Python Files\temp.dat","ab")
        print
        ...
        fin.close()
        fout.close()
        os.remove("E:\Python Files\tickets.dat")
        os.rename("E:\Python Files\temp.dat","E:\Python Files\tickets.dat")
        if (f==0):
            print
...
#__________________RESERVES THE TICKET_______________
    def reservation(self):
        ...
        z=0
        f=0
        fin2=open(r"E:\Python Files\trdetails.dat")
        fin2.seek(0)
        if not fin2:
            print ("ERROR")
        else:            
            try:
                while True:
                    ...
                    if(f==1):
                        fout1=open(r"E:\Python Files\tickets.dat","ab")
                        print
    ...
    while True:
            ...
            if ch==1:
                ...
                if (j==r):
                    x='y'
                    while (x.lower()=='y'):
                        fout=open(r"E:\Python Files\trdetails.dat","ab")
                        tr.getinput()
                        dump(tr,fout)
                        fout.close()
                ...
                fin=open(r"E:\Python Files\trdetails.dat",'rb')
                if not fin:
                    print ("ERROR")
                else:
                    try:
